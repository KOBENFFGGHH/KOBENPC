...
local win = library:Window("KOBEN",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
local General_Tab = win:Tab("Generalแปลว่าเกม",[[7040391851]])
local Quest_Tab = win:Tab("    Quest & Itemแปลทำของ",[[9606626859]])
local PvP_Tab = win:Tab("PvPแปลต่อสู้",[[9606626034]])
local Raid_Tab = win:Tab("Raidแปลดัน",[[9606629300]])
local Shop_Tab = win:Tab("Shopแปลร้านค้า",[[9606625251]])
local Island_Tab = win:Tab("Islandแปลบิน",[[9606628205]])
local Setting_Tab = win:Tab("Settingแปลตั้งค่า",[[9606644121]])
local Status_Tab = win:Tab("Statusแปลสแตส",[[9613645002]])
local Esp_Tab = win:Tab("ESPแปลมองหรือดู",[[9606628205]])
local Hop_Tab = win:Tab("Hopแปลย้ายเซิฟ",[[9608089732]])
